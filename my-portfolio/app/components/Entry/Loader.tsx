...
const Loader = ({
    ...
    return (
        <div
            className={`fixed inset-0 z-[9999] flex flex-col overflow-hidden touch-none overscroll-none transition-all duration-1000 ${isLoaded
        ...
        >
            ...
            {/* PROGRESS BAR */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-[78%] sm:w-[65%] md:w-[60%] h-[2px] bg-white/10 rounded-full overflow-hidden backdrop-blur-md">
                <div
            ...
            >
                <span className="absolute top-[55%] left-1/2 -translate-x-1/2 text-white/80 text-xs sm:text-sm tracking-widest ">
                    {loadingProgress}%
                </span>
            </div>
        </div>
